   ...
   return (
      <>
         <main className="w-full px-4 py-6 space-y-4">
            ...
            <section>
               <h2>Dil</h2>
               <p className="py-4">Uygulama dil tercihlerini yönetin.</p>
            ...
            <section className="">
               <h3>Arayüz Teması ve Renk Şeması Seçenekleri</h3>
               <p className="py-4">
                  Arayüzünüzün nasıl görünmesini istediğinizi seçin.Bir Tema
                  Seçin veya sisteminizle senkronize edin ve otomatik tema
                  değiştirme.
               </p>
               <div className="p-4 bg-main rounded-xl">
